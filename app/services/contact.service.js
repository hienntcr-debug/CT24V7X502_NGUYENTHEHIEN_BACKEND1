...
class ContactService {
	...
	async update(id, payload) {
		...
		// Debug logging: show filter and update payload
		console.log("[ContactService.update] filter:", filter);
		console.log("[ContactService.update] update:", update);
		const result = await this.Contact.findOneAndUpdate(filter, { $set: update },
